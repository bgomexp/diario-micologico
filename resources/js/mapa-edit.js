...
//***********************
// RECUPERACIÓN DE UBICACIÓN EN EL MAPA
// *********************/

//Si la entrada tiene coordenadas, las establecemos como coordenadas iniciales. Si no, se quedan las que hay por defecto.
let oldLocation = false;
let initialLat = 37.348233107188335;
let initialLng = -5.843708844167294;
...
//Si había localización en la entrada, ponemos ya el marcador
if (oldLocation) {
...
document.querySelector("#btnResetUbi").addEventListener("click", e => {
    //Volvemos a las coordenadas por defecto
    map.setView([37.348233107188335, -5.843708844167294], 13);
    //Quitamos el puntero
    if (marker) {
       marker.remove();
       marker = null;
