...
//Validación en el momento de submit del formulario de datos
document.querySelector("#btnGuardarDatos").addEventListener("click", e => {
    let errores = false;
    ...
    if (!errores) {
        document.querySelector("#formDatos").submit();
    }
});

//Validación en el momento de submit del formulario de contraseña
document.querySelector("#btnGuardarPassword").addEventListener("click", e => {
    let errores = false;
    ...
    if (oldPassword=="") {
        document.querySelector("#oldPasswordErrors").innerText = "La contraseña actual es obligatoria";
        campoInvalido(document.querySelector("#old_password"));
        errores = true;
    }else{
        document.querySelector("#oldPasswordErrors").innerText = "";
        campoValido(document.querySelector("#old_password"));
    }

    //Validamos la contraseña nueva
    if (password=="") {
        document.querySelector("#passwordErrors").innerText = "La contraseña nueva es obligatoria";
    ...
    //Si no hay errores, enviamos el formulario al servidor
    if (!errores) {
        document.querySelector("#formPassword").submit();
    }
});
