...
<div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-8 lg:px-12">
        <h2 class="mb-1 text-3xl font-bold tracking-tight leading-none text-gray-900 lg:mb-6 md:text-4xl xl:text-3xl">Nueva especie</h2>
    </div>
<form class="2xl:w-1/2 xl:w-1/2 lg:w-3/5 md:w-3/5 sm:w-3/5 w-4/5" method="post" action="{{route('especies.store')}}">
  ...
  <div class="flex gap-3 justify-between w-full">
    <div class="w-1/3">
      ...
      <div class="mt-2">
        <input id="genero" name="genero" type="text" class="block w-full h-10 rounded-lg bg-white border-gray-300 px-3 py-1.5 text-base text-gray-900 focus:ring-0 focus:border-lime-500 placeholder:text-gray-500  sm:text-sm/6" placeholder="Amanita" value="{{old('genero')}}">
      </div>
    ...
    <div class="w-1/3">
      ...
      <div class="mt-2">
        <input id="especie" name="especie" type="text" class="block w-full h-10 rounded-lg bg-white border-gray-300 px-3 py-1.5 text-base text-gray-900 focus:ring-0 focus:border-lime-500 placeholder:text-gray-500  sm:text-sm/6" placeholder="A. muscaria" value="{{old('especie')}}">
      </div>
    ...
    <div class="w-1/3">
      ...
      <div class="mt-2">
        <input id="nombre_comun" name="nombre_comun" type="text" class="block w-full h-10 rounded-lg bg-white border-gray-300 px-3 py-1.5 text-base text-gray-900 focus:ring-0 focus:border-lime-500 placeholder:text-gray-500  sm:text-sm/6" placeholder="Matamoscas" value="{{old('nombre_comun')}}">
      </div>
