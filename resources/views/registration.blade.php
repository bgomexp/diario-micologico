...
<section class="bg-gray-50 dark:bg-gray-900">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class="w-8 h-8 mr-2" src="https://cdn-icons-png.flaticon.com/512/5635/5635613.png" alt="logo"> <!--Placeholder logo-->
          Diario Micológico    
      </a>
              ...
              <form method="POST" action="{{route('validar-registro')}}" class="space-y-4 md:space-y-6">
                @csrf
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      ¿Ya tienes cuenta? <a href="{{route('login')}}" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Inicia sesión aquí</a>
                  </p>
              </form>
          </div>
      </div>
