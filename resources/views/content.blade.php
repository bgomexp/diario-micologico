...
<section class>
    ...
    <div class="bg-brown-300 py-10 h-auto">
        <div class="p-1 flex flex-wrap items-center justify-center">

    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-lg group cursor-pointer">
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-teal-500 rounded-lg max-w-xs shadow-lg group cursor-pointer">
