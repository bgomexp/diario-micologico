...
<form class="2xl:w-1/2 xl:w-1/2 lg:w-3/5 md:w-3/5 sm:w-3/5 w-4/5" method="post" action="{{route('entradas.store')}}">
  ...
  <div class="mt-5">
    ...
    <div class="mt-2">
      <textarea name="comentarios" id="comentarios" rows="10" class="block w-full rounded-md bg-white border-gray-300 px-3 py-1.5 text-base text-gray-900 placeholder:text-gray-400  focus:outline-1 focus:-outline-offset-1 focus:ring-0 focus:outline-lime-500 sm:text-sm/6"></textarea>
    </div>
  </div>
