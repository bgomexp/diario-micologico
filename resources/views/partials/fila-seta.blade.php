...
@endphp
<div class="fila flex justify-between gap-2 my-2 border-b border-brown-800/10 pb-2">
    <div class="w-full">
    ...
    <div class="w-1/5">
        <input type="number" name="setas[{{ $index }}][cantidad]" value="{{ $data['cantidad'] ?? 1 }}" min="1" class="w-full h-full bg-transparent rounded-lg border-brown-800 border-dashed px-3 py-1.5 text-sm focus:ring-0 focus:border-solid placeholder:text-brown-800 placeholder:opacity-50">
    </div>
